...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#1e1e1f           ctermfg=188 ctermbg=321
    ...
    hi Normal        guifg=#dcdccc guibg=#2e2e2f           ctermfg=188 ctermbg=237
...
if exists("g:zenburn_transparent") && g:zenburn_transparent
    hi Normal             ctermbg=0     guibg=#1e1e1f
...
if version >= 802
    ...
    if version >= 800
        hi Terminal ctermbg=232 guibg=#1e1e1f ctermfg=248 guifg=#a8a8a8
    endif
endif
